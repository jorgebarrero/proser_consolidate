...
import { UserSelectionModel, RealCurrentAgentsModel } from "shared/models";
@Injectable({
  providedIn: "root"
})
export class RealCurrentAgentsService {
  ...
  getReportList(userSelection: UserSelectionModel): Observable<any> {
    ...
    }/api/InvReports/realCurrentAgentsReport?access_token=${accessToken}`;
    const res = this.http
