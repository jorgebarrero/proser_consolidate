...
import { readOriginCdr } from "./transform_cdr_funtions";
    ...
    if (Array.isArray(result)) {
      let extendedResult = result
        .map(x => {
          ...
          x.cdr_agent_people_json = x.inv_agent_people_json;
          x.cdr_agent_operation_json = x.inv_agent_operation_json;
          x.cdr_agent_time_json = x.inv_agent_time_json;
