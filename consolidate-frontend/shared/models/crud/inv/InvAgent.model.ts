...
export class InvAgentModel {
  inv_agent_id: number;
  inv_agent_status: string;
  inv_agent_chk: string;
  inv_agent_name: string;
  inv_agent_shortname: string;
  inv_agent_extension: string;
  inv_agent_legal_id: string;
  inv_agent_internal_id: string;
  inv_agent_type: any;
  ...
  constructor() {
    ...
    this.inv_agent_supervisor_json = [{ id: 0, name: null }];
    this.inv_agent_schedule_json = [{ id: 0, name: null }];

    this.inv_agent_client_json = [{ id: 0, name: null }];
    this.inv_agent_queue_json = [{ id: 0, name: null }];
    this.inv_agent_service_json = [{ id: 0, name: null }];
    this.inv_agent_campaign_json = [{ id: 0, name: null }];

    this.inv_agent_role_json = [{ id: 0, name: null }];
  }
