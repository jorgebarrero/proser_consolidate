...
const currenUser = JSON.parse(localStorage.getItem("currenUser"));
...
export class UserSelectionModel {
  ...
  constructor(options?) {
    if (options === "standard" || options === null) {
      ...
      // OBJECTCS
      this.mode = { id: 0, name: "Actual" };
      this.type = { id: 0, name: "Ejecutado" };
      this.start_time = { id: 0, name: "00 AM", value: "00:00:00" };
      this.end_time = { id: 0, name: "24 PM", value: "24:00:00" };
